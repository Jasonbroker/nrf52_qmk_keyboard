...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______,_______,    _______,        _______, _______, _______,  _______, _______,
        _______, _______, _______, _______, QK_BOOT,   _______, _______, _______, _______,  _______,        _______, _______, _______,  _______, ENT_SLP,
        _______, _______, _______, _______, _______, TOG_GAM, TG(0),   TG(1),   _______,    BL_TOGG,        _______, _______, _______,  _______,
        _______, _______, _______, _______, _______, BL_BRTG, _______, _______, _______,    _______,        _______, _______, BL_UP,    _______,
        _______, _______, _______,          _______,                             _______,    _______,       _______, KC_NO, BL_DOWN,  KC_NO
    ),
    [_extra] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,    _______,        _______, _______, _______,  _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,    _______,        _______, _______, _______,  _______, _______,
