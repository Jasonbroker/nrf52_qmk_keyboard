...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,  _______, _______, KC_RALT,    MO(_FN),        KC_RCTL, KC_LEFT, KC_DOWN,   KC_RGHT
    ),
    [_Mac] = LAYOUT(
    ...
    [_FN] = LAYOUT(
        ...
        _______, AD_WO_L, _______, _______, _______, TOG_GAM, _______, _______, _______,    RGB_TOG,        RGB_HUI, RGB_HUD, _______,  ENT_SLP,
