...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_87_ansi(
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_ENT,         KC_DEL,  KC_END, KC_PPLS,
    ...
    [_FN] = LAYOUT_87_ansi(
        ...
        _______,  _______,  _______,                                        _______,                                        _______,    _______, _______, _______,              UG_PREV, UG_VALD, UG_NEXT
    ),
