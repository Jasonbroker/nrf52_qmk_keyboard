...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        SEL_USB, ADV_ID0, ADV_ID1, ADV_ID2, ADV_ID3, ADV_ID4, ADV_ID5, SEL_RDOE,_______,    _______,        DELBNDS, _______, _______,  _______, REC_DFU,
        _______, BLE_RBD, _______, _______, QK_BOOT,   TESTMOD, _______, _______, _______,    CRGBRST,        CUR_MOD, RGB_SAI, RGB_SAD,  _______, ENT_SLP,
        _______, AD_WO_L, _______, _______, _______, TOG_GAM, TG(0),   TG(1),   _______,    RGB_TOG,        RGB_HUI, RGB_HUD, _______,  _______,
