...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_83(
        ...
        KC_INS,  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_HOME,
        KC_PMNS, KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_PGUP,
        KC_PPLS, KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_PGDN,
    ...
    [_FN] = LAYOUT_83(
        RE_BOOT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, OSSWTCH, _______, ENT_SLP,
        _______, SEL_USB, ADV_ID0, ADV_ID1, ADV_ID2, ADV_ID3, ADV_ID4, ADV_ID5, SEL_RDOE, _______, _______, REC_DFU, _______, _______, _______, _______,
        _______, _______, _______, BLE_RBD, QK_BOOT, _______, TESTMOD, _______, _______, _______, CRGBRST, _______, _______, _______, _______, _______,
        _______, _______, _______, AD_WO_L, _______, _______, TOG_GAM, _______, _______, _______, RGB_TOG, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, BATT_LV, _______, _______, _______, _______, _______, RGB_VAI,
...
uint8_t current_rgblight_mode=9;
...
static bool process_record_user_special(uint16_t keycode, keyrecord_t *record) {
  ...
  case SEL_USB:
    if (pressed) {
        ...
        rgblight_mode(current_rgblight_mode);
        ask_nrf_sleep();
    }
    break;
  case ADV_ID0:
...
case TESTMOD:
  ...
  case KC_CAPS:
  {
    if (record->event.pressed) {
        // 大写锁定键的状态
        if(keyboard_report->mods & MOD_BIT(KC_CAPS))
        {
            if(host_keyboard_leds() & (1 << USB_LED_CAPS_LOCK))
            {
                rgblight_sethsv_noeeprom(255,255,255);
                current_rgblight_mode=9;
                rgblight_mode(current_rgblight_mode);
            }else{
                rgblight_sethsv_noeeprom(255,255,255);
                current_rgblight_mode=15;
                rgblight_mode(current_rgblight_mode);
            }
        }
    }
