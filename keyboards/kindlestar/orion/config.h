...
/* key matrix pins */
#define MATRIX_ROW_PINS {A5, A1, A2, A3, A4, A0}
...
#define KEYSTAR_LED_RED_ON() writePinLow(C15)
#define KEYSTAR_LED_GREEN_ON() writePinLow(C14)
#define KEYSTAR_LED_BLUE_ON() writePinLow(C13)

#define KEYSTAR_LED_RED_OFF() writePinHigh(C15)
#define KEYSTAR_LED_GREEN_OFF() writePinHigh(C14)
#define KEYSTAR_LED_BLUE_OFF() writePinHigh(C13)
